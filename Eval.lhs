...
\subsection{Empty and Singleton Sets}

\subsection{Subsets and Set Equality}

\subsection{Union and Set Difference}

\subsection{Free Variables as Sets}
...
\subsection{Inference Rules and the Turnstile}
...
\subsection{Formation, Introduction and Elimination Rules}

\subsection{Type Variables and Polymorphism}

\subsection{Instantiation and Generalisation}

\subsection{Type Synthesis and Type Checking}
