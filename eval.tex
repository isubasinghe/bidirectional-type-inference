...
\>[B]{}\{\mskip1.5mu \mathbin{\#-}\Conid{LANGUAGE}\;\Conid{DataKinds},\Conid{GADTs},\Conid{KindSignatures},\Conid{StandloneDeriving}\mathbin{-\#}\mskip1.5mu\}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathrel{=}\Conid{EVar}\;\Conid{Var}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Conid{EUnit}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Conid{EAbs}\;\Conid{Var}\;\Conid{Expr}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Conid{EApp}\;\Conid{Expr}\;\Conid{Expr}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mid \Conid{EAnno}\;\Conid{Expr}\;\Conid{PolyType}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\mathbf{deriving}\;(\Conid{Show},\Conid{Eq}){}\<[E]%
\\[\blanklineskip]%
\>[3]{}\mathbf{newtype}\;\Conid{Var}\mathrel{=}\Conid{Var}\;\Conid{String}\;\mathbf{deriving}\;(\Conid{Show},\Conid{Eq},\Conid{Ord}){}\<[E]%
\\[\blanklineskip]%
\>[3]{}\mathbf{data}\;\Conid{TypeKind}\mathrel{=}\Conid{Mono}\mid \Conid{Poly}{}\<[E]%
\\[\blanklineskip]%
\>[3]{}\mathbf{data}\;\Conid{Type'}\mathbin{::}\Conid{TypeKind}\to \mathbin{*}\mathbf{where}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{TUnit}{}\<[14]%
\>[14]{}\mathbin{::}\Conid{Type'}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{TVar}{}\<[14]%
\>[14]{}\mathbin{::}\Conid{TVar}\to \Conid{Type'}\;\Varid{a}{}\<[E]%
\\
\>[3]{}\hsindent{2}{}\<[5]%
\>[5]{}\Conid{TExists}{}\<[14]%
\>[14]{}\mathbin{::}\Conid{TVar}\to \Conid{Type'}\;\Varid{a}{}\<[E]%
